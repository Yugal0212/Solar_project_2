...
const companyLinks = [
  ...
  { label: "FAQ", path: "/faq" },
  { label: "Government Subsidy Info", path: "#" },
  { label: "Testimonials", path: "/testimonials" },
  { label: "Solar Guides", path: "/resources" },
  { label: "Careers", path: "#" },
  ...
  return (
    <footer className="relative bg-[#0B1F3A] text-white overflow-hidden border-t border-white/10">
      ...
      <div
        ...
        style={{
          backgroundImage: "url(/images/ui/green-abstract.png)",
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          {/* Column 1 - Brand */}
          <div>
            <span className="font-heading font-extrabold text-3xl gradient-text">
              Parmayu
            </span>
            <p className="text-sm text-primary-200 mt-2">{company.tagline}</p>
            <p className="text-slate-400 text-sm leading-relaxed max-w-sm mb-6">
              Parmayu is a solar EPC company in Gujarat providing residential,
              commercial, and industrial solar installation, backed by [DUMMY:
              X]+ years of engineering experience.
            </p>
            {/* Social Icons */}
            <div className="flex gap-3 mt-6">
              {[Linkedin, Instagram, Twitter, Youtube].map((Icon, i) => (
                ...
                >
                  <Icon
                    size={16}
                    className="text-primary-200 group-hover:text-white"
                  />
                </a>
              ))}
            </div>
            <p className="text-slate-400 text-sm leading-relaxed max-w-sm mt-4">
              [DUMMY: MNRE Empanelled Solar EPC Company] · [DUMMY: 4.8★ Google
              Rating, 200+ Reviews]
            </p>
          </div>
          ...
          {/* Column 2 - Company */}
          <div>
            <h4 className="text-xs font-bold tracking-widest uppercase text-accent-400 mb-4">
              Company
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-3">
                ...
                <span className="text-primary-100/75">
                  42, Solar Park, Kalawad Road, Rajkot, Gujarat 360001
                </span>
              </li>
              <li className="flex items-center gap-3">
                ...
                <a
                  ...
                  className="text-primary-100/75 hover:text-accent-400 transition-colors"
                >
                  +91 99999 00000
                </a>
              </li>
            ...
            <div className="flex flex-wrap gap-3 mt-4">
              <a
                href={`https://wa.me/${company.whatsapp}?text=${encodeURIComponent("Hello Parmayu Green energy, I am interested in solar installation.")}`}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-[#25D366] text-white text-sm font-semibold px-4 py-2.5 rounded-full hover:brightness-110 transition-all"
              >
        ...
        {/* Service Locations */}
        {/* TODO: verify each city page (Morbi, Rajkot, Jamnagar, etc.) has unique content, not a templated page with just the city name swapped. Duplicate or thin city pages can hurt SEO instead of helping. */}
        ...
        <div className="border-t border-white/10 mt-10 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div>
            <p className="text-xs text-primary-200/50">
              © 2025 Parmayu Green energy Pvt. Ltd. All rights reserved.
            </p>
            <p className="text-xs text-primary-200/50">
              GSTIN: [DUMMY: 24XXXXX1234X1ZX]
            </p>
          </div>
